...
sed -i "s/\$SENTINEL_DOWN_AFTER/${SENTINEL_DOWN_AFTER:-3000}/g" /etc/redis/sentinel.conf
sed -i "s/\$SENTINEL_FAILOVER/${SENTINEL_FAILOVER:-3000}/g" /etc/redis/sentinel.conf
